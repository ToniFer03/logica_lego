...
# Função para gerar uma lista ao calhas de simbolos
...
def jogar_macrofigurax(contador_tabuleiro):
    while lista_simbolos[0].fimMacrofigura != True:
        ...
        if lista_simbolos[0].value == x:
            if (
                tabuleiro[(posicoes_macrox_x[contador_tabuleiro[0]][0])][
                    (posicoes_macrox_x[contador_tabuleiro[0]][1])
                ]
                != " "
            ):
                exit(erro_colocacao_x)
            tabuleiro[(posicoes_macrox_x[contador_tabuleiro[0]][0])][
                (posicoes_macrox_x[contador_tabuleiro[0]][1])
            ] = x
            ...
            if (
                tabuleiro[(posicoes_macrox_bola[contador_tabuleiro[1]][0])][
                    (posicoes_macrox_bola[contador_tabuleiro[1]][1])
                ]
                != " "
            ):
            ...
            if (
                tabuleiro[(posicoes_macrox_cruz[contador_tabuleiro[2]][0])][
                    (posicoes_macrox_cruz[contador_tabuleiro[2]][1])
                ]
                != " "
            ):
            ...
            if (
                tabuleiro[(posicoes_macrox_traco[contador_tabuleiro[3]][0])][
                    (posicoes_macrox_traco[contador_tabuleiro[3]][1])
                ]
                != " "
            ):
...
def jogar():
    ...
    while len(lista_simbolos) > 0:
        if jogo.existe_macrox:  # se existir macrox jogar este
            ...
            if lista_simbolos[0].value == x:
                if (
                    tabuleiro[(posicoes_base_x[contador_tabuleiro[0]][0])][
                        (posicoes_base_x[contador_tabuleiro[0]][1])
                    ]
                    != " "
                ):
                    exit(erro_colocacao_cruz)
                ...
                if (
                    tabuleiro[(posicoes_base_bola[contador_tabuleiro[1]][0])][
                        (posicoes_base_bola[contador_tabuleiro[1]][1])
                    ]
                    != " "
                ):
                    exit(erro_colocacao_bola)
                ...
                if (
                    tabuleiro[(posicoes_base_cruz[contador_tabuleiro[2]][0])][
                        (posicoes_base_cruz[contador_tabuleiro[2]][1])
                    ]
                    != " "
                ):
                    exit(erro_colocacao_cruz)
                ...
                if (
                    tabuleiro[(posicoes_base_traco[contador_tabuleiro[3]][0])][
                        (posicoes_base_traco[contador_tabuleiro[3]][1])
                    ]
                    != " "
                ):
                    exit(erro_colocacao_traco)
...
# Função para limpar figuras completas
...
# Função para verificar se existe uma figura macro_x no tabuleiro
